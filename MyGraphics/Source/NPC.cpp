...
void NPC::Init()
{
	...
	bodyParts[HEAD] = Bodypart(Vector3(0,0,0), Vector3(0,5.25f,0), hitBox, tempMesh, cube);
	...
	bodyParts[BODY] = Bodypart(Vector3(0,0,0), Vector3(0,3.375f,0), hitBox, tempMesh, cube);
	...
	bodyParts[L_ARM] = Bodypart(Vector3(0,0,0), Vector3(-1.125f,3.375f,0), hitBox, tempMesh, cube);
	...
	bodyParts[R_ARM] = Bodypart(Vector3(0,0,0), Vector3(1.125f,3.375f,0), hitBox, tempMesh, cube);

	tempMesh = MeshBuilder::GenerateOBJ("Left Leg", "OBJ//CharOBJ//LeftLeg.obj");
	cube = MeshBuilder::GenerateCube("Head", Color(1,1,1), hitBox.x, hitBox.y, hitBox.z, 0);
	bodyParts[L_LEG] = Bodypart(Vector3(0,0,0), Vector3(-0.375f,1.125f,0), hitBox, tempMesh, cube);

	tempMesh = MeshBuilder::GenerateOBJ("Right Leg", "OBJ//CharOBJ//RightLeg.obj");
	cube = MeshBuilder::GenerateCube("Head", Color(1,1,1), hitBox.x, hitBox.y, hitBox.z, 0);
	bodyParts[R_LEG] = Bodypart(Vector3(0,0,0), Vector3(0.375f,1.125f,0), hitBox, tempMesh, cube);
}
